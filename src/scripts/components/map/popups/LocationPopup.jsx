    ...
    return (
      <div id="location-info-popup" className={cssClass}>
        ...
        <div className="row">
          ...
          <div className="col-lg-5">
            <label className="green text-large bolder">
              {this.props.geometry.coordinates ? this.props.geometry.coordinates.map(function (c) {
        ...
        <div className="row">
          <div className="col-lg-12">
            <label
              className="green text-large bolder">{this.props.featureDesignation.code} - {this.props.featureDesignation.name} </label>
          </div>
        </div>
