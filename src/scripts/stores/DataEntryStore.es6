...
class DataEntryStore extends Reflux.Store {
  ...
  makeGeoCoding(data) {
    ...
    const admins = [];
    let adminCode0, adminCode1, adminCode2, adminName0, adminName1, adminName2;
    ...
    if (countryFeature) {
      ...
      adminCode0 = properties.adminCode0;
      adminName0 = properties.adminName0;
      
      adminCode1 = properties.adminCode1;
      adminName1 = properties.adminName1;
      
      adminCode2 = properties.adminCode2;
      adminName2 = properties.adminName2;
    }
  ...
  setAdministratives(data, vocabulary) {
    let newState = _.cloneDeep(this.state)
    let newLocationFeature = _.cloneDeep(newState.geocoding.locationFeature)
    const admins = [];
